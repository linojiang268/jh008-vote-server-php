...
class PlaneModelVoteRepositoryTest extends TestCase
{
    ...
    public function testAdd()
    {
        ...
        self::seeInDatabase('plane_model_votes', ['voter' => '12345678912', 'user_id' => 40988]);
    }
    ...
    //            findVoteCountByUser
    //===========================================
    public function testFindVoteCountByUser()
    {
        $this->createData();
        $result = $this->getRepository()->findVoteCountByUser();
    ...
    /**
     * @return \Jihe\Repositories\PlaneModelVoteRepository
     */
