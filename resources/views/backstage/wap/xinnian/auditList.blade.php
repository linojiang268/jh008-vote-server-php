...
<script id="detail_template" type="text/template">
        <div class="detail-dia-con">
            <div class="ui-form" name="" method="post" action="#" id="">
                ...
                <div class="ui-form-item">
                    ...
                    <div class="ui-form-item-wrap">
                        <div class="ui-form-item-text"><%= id_number %></div>
                    </div>
                </div>

                <div class="ui-form-item">
                    <label for="" class="ui-label">出生年月:</label>
                    <div class="ui-form-item-wrap">
                        <div class="ui-form-item-text"><%= date_of_birth %></div>
                    </div>
                </div>

                <div class="ui-form-item">
                    <label for="" class="ui-label">毕业院校/学历:</label>
                    <div class="ui-form-item-wrap">
                        <div class="ui-form-item-text"><%= universityAndDegree %></div>
                    </div>
                </div>
                <div class="ui-form-item">
                ...
                <div class="ui-form-item">
                    ...
                    <div class="ui-form-item-wrap">
                        <div class="ui-form-item-text"><%= yearly_salary %>万</div>
                    </div>
                </div>
                <div class="ui-form-item">
                    <label for="" class="ui-label">个人才艺:</label>
                    <div class="ui-form-item-wrap">
                        <div class="ui-form-item-text"><%= talent %></div>
                    </div>
                </div>
                <div class="ui-form-item">
                    <label for="" class="ui-label">择偶要求:</label>
                    <div class="ui-form-item-wrap">
                        <div class="ui-form-item-text"><%= mate_choice %></div>
                    </div>
                </div>
    ...
    <script src="/static/xinnian/js/server.js"></script>
    <script src="/static/js/common/json2.js"></script>
    <script src="/static/js/common/artTemplate.js"></script>
    <script src="/static/xinnian/js/auditList.js"></script>
</body>
</html>