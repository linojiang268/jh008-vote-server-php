...
class UEditorFileController extends Controller
{
    /**
     *  upload file
     */
    public function upload(Request $request, StorageService $storageService)
    {
        try {
            switch ($request->get('action')) {
                ...
                case 'uploadvideo':
                case 'uploadfile':
                    $result = $this->store($request, $storageService);
                    break;
                case 'config':
                    $result = $this->getConfig();
                    break;
                case 'uploadscrawl': /* upload scrawl */
    ...
    private function store(Request $request, StorageService $storageService)
    {
        ...
        try {
            ...
            $url = $storageService->storeAsTmpImage($file);
