...
use Jihe\Events\UserApplicantApprovedAndWaitPayEvent;
...
class UserApplicantApprovedAndWaitPayEventListener implements ShouldQueue
{
    use DispatchesJobs;
     ...
     * @return void
     */
    public function handle(UserApplicantApprovedAndWaitPayEvent $event)
    {
        try {
