 ...
 * 
 */
class AlipayWapService extends AbstractAlipayService
{
    ...
    {
        parent::__construct($config, $httpClient, $hasher);
     ...
     * @param string $payExpire    expire time in miniutes. default to 60 min (range [1, 21600], 21600min = 15days)
