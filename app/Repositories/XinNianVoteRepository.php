...
class XinNianVoteRepository
{
    const PREFIX = 'xinnian';
    const USER_VOTE_COUNT_KEY = self::PREFIX.'_user_vote_count';
    const ALL_VOTE_COUNT_KEY = self::PREFIX.'_all_vote_count';
    const VOTER_TODAY_VOTE_COUNT_KEY = self::PREFIX.'_voter_today_vote_count';
    const GROUP_BY_USER_COUNT_SORT_KEY = self::PREFIX.'_group_by_user_sort_count';
    const ALL_USER_VOTE_COUNT_KEY = self::PREFIX.'_all_user_vote_sort_key';
    const ALL_USER_VOTE_SORT_KEY = self::PREFIX.'_all_user_vote_count_key';
    const USER_SORT_KEY = self::PREFIX.'_user_sort';
    const WX_VOTE_NUM = 5;
