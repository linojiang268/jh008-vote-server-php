...
class PlaneModelVoteRepository
{
    const USER_VOTE_COUNT_KEY = 'plane_model_user_vote_count';
    const ALL_VOTE_COUNT_KEY = 'plane_model_all_vote_count';
    const VOTER_TODAY_VOTE_COUNT_KEY = 'plane_model_voter_today_vote_count';
    const GROUP_BY_USER_COUNT_SORT_KEY = 'plane_model_group_by_user_sort_count';
    const ALL_USER_VOTE_COUNT_KEY = 'plane_model_all_user_vote_count_key';
    const USER_SORT_KEY = 'plane_model_user_sort';
    const WX_VOTE_NUM = 1;
